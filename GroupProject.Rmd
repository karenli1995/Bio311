...
#dataset containing only coding genes
...
huebert_expmt2$expt <- c(rep("wildtype", 11), rep("msn24", 11))
huebert_expmt2$time <- huebert_times
# reorder
huebert_expmt2 <- huebert_expmt2[,c(6640:6641, 1:6639)]
```
...
huebert.cor <- huebert_expr_coding %>% cor(use = "pairwise.complete.obs")
