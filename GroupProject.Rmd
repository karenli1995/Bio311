...
>>>>>>> 1bdcd4f84734968a03f69bc7548d3b9a8cd2cd0e
...
for (i in 1:nrow(harbison_tfs_h2o2)) {
  for (j in 1:ncol(harbison_tfs_h2o2)) {
    if (harbison_tfs_h2o2[i, j] <= 0.0001 & !is.na(harbison_tfs_h2o2[i, j])) {
      n_df <- rbind(n_df, 
...
l <- layout_nicely(g)
plot(g, layout = l, edge.arrow.size = .1, vertex.shape="none", vertex.label.cex = 0.3)
```
